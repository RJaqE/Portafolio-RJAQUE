...
Estas son las tecnologías principales que utilizo en mis proyectos y en la construcción de este portafolio:
...
| Proyecto | Descripción | Stack | Enlaces |
| :--- | :--- | :--- | :--- |
| **Galería de Pokemones** | Aplicación interactiva que consume la PokeAPI para mostrar listados dinámicos. | `JavaScript` `API` `DOM` | [📂 Código](https://github.com/RJaqE/Galeria-de-Pokemones) <br> [🔗 Demo](https://rjaqe.github.io/Galeria-de-Pokemones/) |
| **Landing Seguridad** | Página de aterrizaje estática, enfocada en diseño responsivo y maquetación semántica. | `HTML5` `CSS3` | [📂 Código](https://github.com/RJaqE/Proyecto_Seguridad) <br> [🔗 Demo](https://rjaqe.github.io/Proyecto_Seguridad/) |
...
* **LinkedIn:** [linkedin.com/in/rhjaque](https://www.linkedin.com/in/rhjaque)
* **Email:** [jaquecl@gmail.com](mailto:jaquecl@gmail.com)
